...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image_tensor = process_images([image], self.image_processor, self.model_config)[1][0]
...
def eval_model(args):
    ...
    fastv_config = {"K": args.K, "R": args.R, "C": args.C}
    tokenizer, model, image_processor, context_len = load_pretrained_model(
        model_path, args.model_base, model_name,
        visual_token_num=args.visual_token_num,
        use_fastv=args.use_fastv, fastv_config=fastv_config
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_fastv", action="store_true")
    parser.add_argument("--K", type=int, default=2)
    parser.add_argument("--R", type=int, default=50)
    parser.add_argument("--C", type=str, default="last")
