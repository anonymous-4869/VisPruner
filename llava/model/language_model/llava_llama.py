...
class FastVLlavaLlamaModel(LlavaMetaModel, FastVLlamaModel): # Alter LlavaLlamaModel to FastVLlavaLlamaModel
    config_class = LlavaLlamaConfig
...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def __init__(self, config, visual_token_num=None, use_fastv=False, fastv_config=None):
        super(LlamaForCausalLM, self).__init__(config)
        if not use_fastv:
            print("Disable FastV!")
            self.model = LlavaLlamaModel(config)
        else:
            print(f"Enable FastV: {fastv_config}")
